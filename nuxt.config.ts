...
export default defineNuxtConfig({
  ...
  app: {
    head: {
      title: 'Shalsabilla Wahyu — Frontend Developer & UI/UX Designer',
      meta: [
        { charset: 'utf-8' },
        { name: 'viewport', content: 'width=device-width, initial-scale=1' },
        {
          name: 'description',
          content:
            'Portfolio of Shalsabilla Wahyu — Frontend Developer, UI/UX Designer & Graphic Designer based in Surabaya, Indonesia.',
        },
      ],
      link: [
